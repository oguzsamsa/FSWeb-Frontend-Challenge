  ...
  return (
    <div className="w-full bg-white pb-20">
      <div className="w-4/5 max-w-4xl mx-auto flex flex-col">
        <h1 className="text-black font-semibold text-5xl mb-6 text-center md:text-start">
          Projects
        </h1>
        <div className=" flex flex-col items-center gap-4 md:flex-row md:justify-between md:items-stretch md:gap-0">
          <div className="w-3/5 md:w-1/4">
            <img
              ...
              alt=""
            />
            <h2 className="text-[#4338CA] font-medium text-3xl my-2">
              Workintech
            </h2>
            ...
            <div className="flex my-2 gap-2">
              <p className="text-[#3730A3] text-xs font-medium border border-[#3730A3] py-1 px-2 rounded">
                react
              </p>
              <p className="text-[#3730A3] text-xs font-medium border border-[#3730A3] py-1 px-2 rounded">
                redux
            ...
            <div className="flex justify-between">
              <a className="text-[#3730A3] font-medium underline" href="">
                Github
              </a>
              <a className="text-[#3730A3] font-medium underline" href="">
                View Site{" "}
